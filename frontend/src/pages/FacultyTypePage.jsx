  ...
  return (
    <div className={`flex flex-col w-full transition-colors duration-300 ${darkMode ? 'bg-black' : 'bg-gray-50'}`}>
      <div className="min-h-screen flex flex-col items-center justify-center px-4 relative py-20">
        ...
        <p className={`text-lg mb-16 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>What best describes you?</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl w-full">
          ...
          >
            ...
            <h2 className={`text-2xl font-bold mb-3 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Institution Faculty</h2>
          ...
          >
            ...
            <h2 className={`text-2xl font-bold mb-3 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Solo Teacher</h2>
            <p className={`text-sm leading-relaxed ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
