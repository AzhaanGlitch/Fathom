          ...
          <div className="mt-8 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 px-4 py-3 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
                  {user.emailVerified ? (
                    <><div className="w-2 h-2 rounded-full bg-green-400" /><span className="text-white">Verified</span></>
                  ) : (
                    <><div className="w-2 h-2 rounded-full bg-yellow-400" /><span className="text-white">Not Verified</span></>
                  )}
                </div>
              </div>
              ...
              {userRole === 'institution-faculty' && institutionName && (
                <div>
                  ...
                  <div className="flex items-center gap-2 px-4 py-3 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
                    <span className="text-white">{institutionName}</span>
                  </div>
                </div>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <GlassCard className="hover:bg-white/10 hover:border-white/20 transition-all">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-gray-400">{isAdmin ? 'Total Sessions' : 'My Sessions'}</p>
            </div>
