        ...
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
          <div className="flex gap-4 flex-col">
            ...
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-gray-600 dark:text-gray-300 max-w-2xl text-center px-4 transition-colors duration-300">
              Transform your teaching assessment with AI-powered insights. Fathom provides detailed, explainable evaluations across multiple dimensions including clarity, structure, correctness, pacing, and communication. Get actionable feedback that helps educators improve their teaching quality.
            </p>
          </div>
